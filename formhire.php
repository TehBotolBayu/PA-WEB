...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO konten (judul, deskripsi, skill, kategori, harga, tanggal, tipe, gambar, id_akun) VALUES ('$judul', '$deskripsi', '$skill_new', '$kategori_new', '$harga', '$tanggal', 't', '$filename', '$id_akun')";
